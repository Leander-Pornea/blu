  ...
  return (
    <div className="flex flex-col items-start justify-start min-h-[calc(100vh-3.5rem)] w-full px-4 py-6 md:px-6 md:py-8">
      <div className="flex flex-col items-start justify-start gap-3 md:gap-4 w-full max-w-3xl">
        ...
        <div className="flex flex-col items-stretch justify-start gap-3 md:gap-4 h-full">
          <div className="flex flex-col sm:flex-row items-stretch justify-start gap-3 md:gap-4 h-full">
            <LoginForm />
            <SignUpForm />
          </div>
          <CustomerForm />
